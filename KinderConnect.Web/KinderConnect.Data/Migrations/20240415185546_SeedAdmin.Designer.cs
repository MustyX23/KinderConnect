...
namespace KinderConnect.Data.Migrations
{
    ...
    [Migration("20240415185546_SeedAdmin")]
            ...
            modelBuilder.Entity("KinderConnect.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "99fa0334-8b95-44f7-b463-1171d7e48b46",
            ...
            modelBuilder.Entity("KinderConnect.Data.Models.Child", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0a855899-c3f2-4f0c-9a6c-bce5ff8c7c69"),
                            Age = 4,
                        ...
                        new
                        {
                            Id = new Guid("5733c87d-cf9e-4ba2-999f-7e121ebc0bcd"),
                            Age = 3,
                            ClassroomId = new Guid("632bc679-3cc2-45b7-971b-6a92105321de"),
                        ...
                        new
                        {
                            Id = new Guid("2d7e7fb3-ea5d-4e1a-9555-3c5fc84468b5"),
                            Age = 4,
                        ...
                        new
                        {
                            Id = new Guid("be7e8b16-9f78-487a-b849-26e5337f5b5c"),
                            Age = 5,
                            ClassroomId = new Guid("958b5667-9055-40a7-b7b2-81c19afe3329"),
                        ...
                        new
                        {
                            Id = new Guid("bec91af2-0548-4191-bc28-2bc030f20c5f"),
                            Age = 4,
                            ClassroomId = new Guid("958b5667-9055-40a7-b7b2-81c19afe3329"),
                            DateOfBirth = new DateTime(2020, 3, 10, 19, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Emma",
                        ...
                        new
                        {
                            Id = new Guid("235099eb-b131-4260-8823-0d0b37c58414"),
                            Age = 6,
                        ...
                        new
                        {
                            Id = new Guid("560d474a-7a3a-441f-a596-6f35911a3e10"),
                            Age = 7,
                            ClassroomId = new Guid("c12f8035-d854-4cdc-bad7-489237b10fdf"),
                        ...
                        new
                        {
                            Id = new Guid("b4f1eeaa-ba35-4885-9e6d-f130acc616ef"),
                            Age = 10,
                        ...
                        new
                        {
                            Id = new Guid("1c20238f-e154-4fe7-9b39-3ee168a04b17"),
                            Age = 11,
                            ClassroomId = new Guid("4faa63ab-f5f8-45ae-bdc4-2eb42ca9b266"),
            ...
            modelBuilder.Entity("KinderConnect.Data.Models.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7332),
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7393),
                        ...
                        new
                        {
                            Id = new Guid("7da241ef-3c63-4032-b7ca-e581f4764268"),
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7404),
                        ...
                        new
                        {
                            Id = new Guid("6f9ba52a-082a-4072-8d2e-27d9e8e08bd2"),
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7413),
                        ...
                        new
                        {
                            Id = new Guid("2678f988-3bff-42d2-9dcc-6a8f02cef9eb"),
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7427),
                        ...
                        new
                        {
                            Id = new Guid("f87ae57c-1dca-4d37-9457-dc39e7ebdc7a"),
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7445),
                        ...
                        new
                        {
                            Id = new Guid("66b3810e-6a35-409f-95ea-2da2e2e381be"),
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7453),
                        ...
                        new
                        {
                            Id = new Guid("ad3e25b4-fb02-43e6-8edc-c46bcef1e7ce"),
                            CreatedOn = new DateTime(2024, 4, 15, 21, 55, 45, 1, DateTimeKind.Local).AddTicks(7461),
            ...
            modelBuilder.Entity("KinderConnect.Data.Models.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dfeef6f3-006c-4845-b6c0-da013ad641d4"),
                        ...
                        new
                        {
                            Id = new Guid("bd1f16de-2dae-4001-b3e6-5ea2b78e7a5f"),
                        ...
                        new
                        {
                            Id = new Guid("d3fecb5e-ed6d-42c1-a3a4-6d0718501246"),
                        ...
                        new
                        {
                            Id = new Guid("a8df49a5-5167-4046-a17b-db9ee8c7e1a6"),
                        ...
                        new
                        {
                            Id = new Guid("6aced0d7-f614-4fe7-8b83-94d20575eff0"),
                        ...
                        new
                        {
                            Id = new Guid("e30a8787-2ce7-490b-b050-012084281068"),
